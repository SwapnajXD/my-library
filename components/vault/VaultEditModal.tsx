        ...
        <header className="flex justify-between items-center border-b border-[#1A1A1A] pb-8">
          <div className="flex items-center gap-6">
             <div className="flex items-center gap-4">
                <div className="p-3 bg-[#050505] border border-[#1A1A1A] rounded-2xl text-sky-500">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => setIsSearching(true)} className="flex items-center gap-2 bg-white text-black h-12 px-8 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-sky-500 hover:text-white transition-all shadow-2xl">
          ...
          <section className="bg-[#050505] border border-[#1A1A1A] rounded-[32px] p-8 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div>
                ...
                <p className="text-xs text-[#444444] font-medium italic">Manage your local database backups and storage protocol.</p>
              </div>
              <div className="flex gap-4 w-full md:w-auto">
                <button 
                  onClick={exportVault}
                  className="flex-1 md:flex-none flex items-center justify-center gap-3 px-6 py-4 bg-[#0A0A0A] border border-[#1A1A1A] rounded-2xl text-[10px] font-black uppercase tracking-widest text-white hover:border-sky-500 transition-all"
                >
